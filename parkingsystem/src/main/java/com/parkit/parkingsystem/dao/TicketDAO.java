...
public class TicketDAO {
    ...
    public boolean saveTicket(Ticket ticket) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            logger.error("Error saving ticket info to DB",ex);
            throw ex;
        }finally {
    ...
    public int getNbTicket(String vehicleRegNumber) throws ClassNotFoundException {
        ...
        try {
            con = dataBaseConfig.getConnection();
            PreparedStatement preparedStatement = con.prepareStatement("SELECT COUNT(*) FROM ticket WHERE vehicle_reg_number=?");
